...
local esxJobGlobalControllers = { -- ESX jobs that can access /ves is all vehicle plates.
    {'dj', 'boss'}, -- ESX "dj" job with "boss" grade can access /ves in all vehicle plates.
...
function CanAccessControllerInterface(source, plate)
    ...
    if (ESX) then
        ...
        local esxJobName = esxPlayer and esxPlayer.job and esxPlayer.job.name
