...
const _CSS_notchOffset = '14%' // If your phone is using a skin with a notch you can specify the top distance it takes here.
const _CSS_bottomToTop = '15px' // The distance from bottom to top to animate the bottom elements to.
